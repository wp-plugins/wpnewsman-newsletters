...
* Fixed resending of re-subscription emails
* Fixed recalculation of recipients numbers on email sending start-stop
* Improved sender worker stability

= 1.8.9 =

* Fixed an error which on some hostings caused sending of multiple copies of email to subscribers.
...
* Fixed PHP notices and warnings during subscription.
...
* Fixed bug wich caused rejection of complex email address( with characters like ' in it )

= 1.7.8 =

* Fixed bug which caused an error if recipient unsubscribed from the welcome email.
...
* Fixed export to CSV bug occurred on some WordPress installations.
* Added email publishing feature.
* Added Spanish translation
* Fixed antispam beacon encoding which affected the work of bounce-handler
* Added [newsman fn=] shortcode. For example, output the post author name - [newsman fn='the_author']

= 1.6.6 =
* Fixed: after saving and sending emails and email templates &nbsp; html entity was converted to question mark("?")
...
* Changed: mailbox underlying API output to increse performance.
...
* Added: unsubscribe link in a test email works now.
...
* Added: Little improvements to the form builder.
...
* Fixed: bug that sometimes cause sender process to crash
...
= 1.1.1 =
* Fix form list styling ul.newsman-form li
* removed unused js file
* enhanced bounced handler
* tweked blog digest template
...
* tweaked system email template to look nice in the hotmail/live webmail
...
= 1.7.6 =
Highly recommended update. Fixed critical bug.

= 1.7.3 =
Recommended upgrade. Lots of small bug fixes and improvements.

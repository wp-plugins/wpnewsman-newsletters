<div class="wrap wp_bootstrap" id="newsman-page-upgrade-to-pro">
	...
	<div class="row-fluid">
		<div class="span8">
			...
			<div style="margin-top: 25px;"><?php echo sprintf( __('or get special <a href="https://secure.avangate.com/order/checkout.php?PRODS=4630229&QTY=3&CART=1&CLEAN_CART=1&ADDITIONAL_site_address[4630229]=%s">3-site discounted license for $%s</a> <br><br> To activate the PRO version, you\'ll need to download an extra plugin WPNewsman Pro Extension.', NEWSMAN), $domain, 99 );?></div>
			<?php endif; ?>
		</div>
	</div>
